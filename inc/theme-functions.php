...
// * @return object
// */
//function build_location_object(): string {
//    $query = get_post_content('retailer', 2000);
...
//                "maxZoom":17
//                },';
//    $rtn .= '"mapsApiKey": "'. $googleAPIKey .'",';
//        if ( $query->have_posts()){
//            $rtn .= '"locations": [';
//            while ( $query->have_posts() ){
//                $query->the_post();
//            // Gets all the retail information from ACF
//            $location = get_field( 'location' );
//            $name     = get_the_title();
//            $number   = get_field( 'telephone_number' );
//            $products = get_field( 'products' );
//            $productsArray = '';
//                // Checks which products are available
//                if ( ! empty( $products ) ) {
//                    foreach( $products as $product ) {
//                        $productsArray .=    "<li class='retailer-card__product'>";
//                            $productsArray .=  "<svg class='retailer-card__product-icon icon icon--m icon--red'>";
//                            $productsArray .= "<use xlink:href='#icon-done'></use>";
//                            $productsArray .= "</svg>";
//                            $productsArray .=     "<span class='retailer-card__product-text'>";
...
//                }
//            // Number displayed within the location icon
//            $count = '"count": "'. $i .'", ';
//            // Builds the get directions link";
//            $directions_link = '';
//            if ( ! empty( $location['address'] ) ) {
//                $directions_link = ' "directions_link": "https://www.google.com/maps/dir//' . str_replace( ' ', '+', strtolower( $location['address'] ) ) . '", ';
//            }
//            if ( ! empty( $location && $location['lat'] && $location['lng'])  ){
//                $rtn .= '{';
//                $rtn .= $products . $directions_link . $count;
//                $rtn .= '"number":"' . $number . '",
//                    "title":"' . $name . '",
